...
public Person()
{
	this.firstNameField = FIRST_NAME_REPLACEMENT;
	this.lastNameField = LAST_NAME_REPLACEMENT;
...
public void displayValues()
{
    ...
    System.out.println(this.ageField);
}
...
public String toString()
{
	...
	return "First: " + this.firstNameField + " Last: " + this.lastNameField + " Age: " + this.ageField;
}
}
